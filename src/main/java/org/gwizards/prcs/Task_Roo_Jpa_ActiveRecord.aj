...
privileged aspect Task_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> Task.fieldNames4OrderClauseFilter = java.util.Arrays.asList("");
    ...
    public static Task Task.findTask(Integer taskNo) {
        if (taskNo == null) return null;
        return entityManager().find(Task.class, taskNo);
    }
    ...
    public void Task.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Task attached = Task.findTask(this.taskNo);
