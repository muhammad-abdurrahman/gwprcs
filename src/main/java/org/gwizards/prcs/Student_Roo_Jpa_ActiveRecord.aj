...
privileged aspect Student_Roo_Jpa_ActiveRecord {
    ...
    public static Student Student.findStudent(Integer studentNo) {
        if (studentNo == null) return null;
        return entityManager().find(Student.class, studentNo);
    }
    ...
    public void Student.remove() {
        ...
        if (this.entityManager.contains(this)) {
            ...
            Student attached = Student.findStudent(this.studentNo);
